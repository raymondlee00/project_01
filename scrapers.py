...
def getbackgroundmap(minlat, maxlat, minlong, maxlong, mylat, mylong):
    app_id = None
    app_code = None
    ...
    reqbuilder += "app_id=" + app_id + "&app_code=" + app_code
    print(reqbuilder)




getbackgroundmap(39.7263, 41.7263, -74.9818, -72.9818, 40.6263, -73.9818)
